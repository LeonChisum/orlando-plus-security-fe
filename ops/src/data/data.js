...
export const managementData = [
	...
	},
	{
		...
		bio:
			'Christine graduated from University of Central Florida with a double major in Marketing and Finance. She has been in the hospitality and event industry since childhood. Christine has many years of experience in preparing and facilitating security plans with both show management and the venue. She can assist in coordinating and contracting Off Duty Law Enforcement, K9s, and Event Medical services for events and incorporating them into one contract. Christine has knowledge with events in different cities across the country.',
		id: 2,
	},
	{
		name: 'Tristan Wong',
...
export const servicesData = [
	{
		...
		icon: 'guards',
		info:
			'OPS offers a wide range of security services, specializing in trade shows, conventions and special events. We have armed, unarmed and executive protection security officers available. ',
		id: 1,
	},
	{
		...
		icon: 'staff',
		info:
			'Customer service comes first! We have talented and experienced staff waiting to work your next event. We offer bag fulfillment, room monitors, registration assistance, ticket takers, directional staff and secretaries to name a few.',
		id: 2,
	},
	{
		title: 'CCTV',
	...
	},
	{
		...
		icon: 'consultant',
		info:
			'The OPS Management Team has experience with trade show and conventions throughout the US. We can assist with all your security needs, from start to finish. Let us take care of security off your plate, when planning your next convention.',
		id: 4,
	},
	{
		...
		icon: 'contract',
		info:
			'Let OPS be your one stop shop! We’ve maintained relationshipswith companies that offer other convention services, so our clients are able to sign just one contract and send one deposit. Let us coordinate your Off-Duty Law Enforcement, K9s and Medical services, you have enough to plan.',
		id: 5,
	},
];
